...
public class DatabaseLoader implements CommandLineRunner {
	...
	private final TruckUsageDataRepository truckUsageRepository;
private final CustomerRepository orRepository;
	...
	public DatabaseLoader(EmployeeRepository repository,
						  ...
						  TruckUsageDataRepository truckUsageRepository) {
		this.repository = repository;
		...
		this.truckUsageRepository = truckUsageRepository;
	...
	public void run(String... strings) throws Exception {
		...
		this.userRepository.save(new User("User1", "123456th", "HR", "admin"));
